...
{
public:
    MAX31856(spi_host_device_t aHostId, spi_bus_config_t aBusConfig = defaultSpi3BusConfig);
    ...
    float readColdJunction(uint8_t anIndex = 0);
    float readTemperature(uint8_t anIndex = 0);
...
private:
    ...
    Result myLastResult[3];
    ThermocoupleType myThermocoupleType[3];
