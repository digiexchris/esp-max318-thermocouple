...
namespace ESP_MAX318_THERMOCOUPLE
{
	...
	public:
		...
		const uint8_t MAX31856_FAULT_CJRANGE = 0x80;
		const uint8_t MAX31856_FAULT_TCRANGE = 0x40;
		const uint8_t MAX31856_FAULT_CJHIGH = 0x20;
		const uint8_t MAX31856_FAULT_CJLOW = 0x10;
		const uint8_t MAX31856_FAULT_TCHIGH = 0x08;
		const uint8_t MAX31856_FAULT_TCLOW = 0x04;
		const uint8_t MAX31856_FAULT_OVUV = 0x02;
		const uint8_t MAX31856_FAULT_OPEN = 0x01;
