...
constexpr uint8_t MAX31855_FAULT_OPEN =
    0x01; ///< Enable open circuit fault check
constexpr uint8_t MAX31855_FAULT_SHORT_GND =
    0x02; ///< Enable short to GND fault check
constexpr uint8_t MAX31855_FAULT_SHORT_VCC =
    0x04; ///< Enable short to VCC fault check
constexpr uint8_t MAX31855_FAULT_ALL = 0x07; ///< Enable all fault checks

/**
 * @brief MAX31855 SPI device class
 *
 * This class provides a simple interface to read temperature data from the
 * MAX31855 thermocouple-to-digital converter. It uses SPI communication to
 * interact with the device.
 *
 * It implements some features in software that are available in hardware in the
 * MAX31856, such as: Over and under temperature detection Sample averaging
 */
...
public:
  ...
  struct MAX31855Config : MAX318Config {
    ...
    float temp_fault_high = 1370.0f;        // High temperature fault threshold
